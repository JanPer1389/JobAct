...
(work report, materials, cost estimate) and the BEFORE/AFTER visual
comparison land on the same `ReportRevision` together, or neither does.
        ...
        try:
            ...
            agent_result = await self._run_visual_audit(
                ...
                provided_price_usd=provided_price_usd(
                    drafted.amount_cents, "RUB", self._fx.usd_rub_rate
                ),
                image_pairs=image_pairs,
